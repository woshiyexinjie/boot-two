...
@Configuration
@MapperScan(basePackages = {"com.helloxin.mapper.alocal"}, sqlSessionFactoryRef = "sqlSessionFactoryDb2")
public class Db2Config {
    ...
    public SqlSessionFactory sqlSessionFactoryDb2() throws Exception {
        ...
        factoryBean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:alocal/*.xml"));
